  ...
  return (
    <div>
      ...
      <div className='form-container' >
        <h2 className='titulo'>Busqueda de Empleados</h2>
          <form id= "busquedaCedula" action="#">
            <div className='input'>
              <label htmlFor="name">Cédula</label>
              <input type="text" id="id" name="id" placeholder="Ingresar cédula..." value={cedula} onChange={validarCedula} pattern="^\d+$" title="Solo números" required >
              </input>
            </div>
